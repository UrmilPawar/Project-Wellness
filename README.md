# WellPro
WellPro is a website that leverages Deep Learning to predict diseases or illnesses based on user's symptoms and images of affected body parts. With a user-friendly interface, WellPro helps users receive easy diagnoses and recommendations. Moreover, the platform facilitates users to provide feedback and opinions, which will further help to develop the quality of the service. It's responsive design can help people to view this website effectively on any device. Additionally, WellPro offers chatbot services, providing quick and efficient resolution to any health-related queries.
Such A service is helpful for the people who live in remote or underdeveloped areas having limited or no access to hospitals or doctors and even in developed areas where overburdened healthcare systems are unable to provde services to each and every individual.
